...
if ! options=$(getopt -o h --long Sample_ID:,TISSUE:,MULTIPLE_VCF_PATH:,MULTIPLE_VCF_GZ_PATH:,INDIVIDUAL_VCF_PATH:,INDIVIDUAL_VCF_GZ_PATH:,INDIVIDUAL_RESCUED_VCF_PATH:,INDIVIDUAL_RESCUED_VCF_GZ_PATH:,INDIVIDUAL_UNIQUE_VCF_PATH:,INDIVIDUAL_UNIQUE_VCF_GZ_PATH:, -- "$@")
then
...
bgzip -c -f ${INDIVIDUAL_RESCUED_VCF_PATH} > ${INDIVIDUAL_RESCUED_VCF_GZ_PATH}
tabix -p vcf ${INDIVIDUAL_RESCUED_VCF_GZ_PATH}

bgzip -c -f ${INDIVIDUAL_UNIQUE_VCF_PATH} > ${INDIVIDUAL_UNIQUE_VCF_GZ_PATH}
tabix -p vcf ${INDIVIDUAL_UNIQUE_VCF_GZ_PATH}