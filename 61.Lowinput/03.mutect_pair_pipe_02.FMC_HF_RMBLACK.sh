...
if ! options=$(getopt -o h --long Sample_ID:,OUTPUT_VCF_GZ:,OUTPUT_FMC_PATH:,OUTPUT_FMC_HF_PATH:,OUTPUT_FMC_HF_RMBLACK_PATH:,PON:,REF:,gnomad:,INTERVAL:,TMP_PATH:,SAMPLE_THRESHOLD:,DP_THRESHOLD:,ALT_THRESHOLD:,REMOVE_MULTIALLELIC:,PASS:,REMOVE_MITOCHONDRIAL_DNA:,BLACKLIST:, -- "$@")
then
