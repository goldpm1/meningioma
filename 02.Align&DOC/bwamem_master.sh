...
for sublog in 03.depthofcoverage; do
...
for idx in ${!sample_name_LIST[@]}; do
    ...
    for TISSUE in Blood Tumor Dura; do
        ...
        --FASTQ_PATH_1 ${FASTQ_PATH_1} --FASTQ_PATH_2 ${FASTQ_PATH_2}  --PRE_BAM_PATH ${PRE_BAM_PATH} --REF ${REF_hg19} --TMP_PATH ${TMP_PATH}
        ...
        --REF ${REF_hg19} --dbsnp ${dbsnp} --TMP_PATH ${TMP_PATH}
