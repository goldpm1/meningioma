...
if ! options=$(getopt -o h --long Sample_ID:,TISSUE:,PRE_BAM_PATH:,MarkDuplicate_PATH:,AddOrReplaceReadGroups_PATH:,BQSR_PATH:,BQSR_RECAL_PATH:,FINAL_BAM_PATH:,REF:,dbsnp:,TMP_PATH:, -- "$@")
then
