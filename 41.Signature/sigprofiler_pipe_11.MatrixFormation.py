...
if __name__ == "__main__":
    ...
    parser.add_argument("--SIGPROFILER_INPUT_VCF_DIR", type = str, default = "/data/project/Meningioma/41.Signature/01.SigProfiler/01.vcf/Dura" )
    parser.add_argument("--SIGPROFILER_INPUT_MATRIX_DIR", type = str, default = "/data/project/Meningioma/41.Signature/01.SigProfiler/11.matrix/Dura/" )
